...
var Server = /** @class */ (function () {
    ...
    Server.prototype.start = function (createConnection, opts) {
        var _this = this;
        if (createConnection === void 0) { createConnection = function () { return Promise.resolve(); }; }
        if (opts === void 0) { opts = {}; }
        var resolvedOpts = __assign({ env: process.env.NODE_ENV, port: process.env.PORT || 3000 }, opts);
            ...
            createConnection()
                ...
                return __generator(this, function (_a) {
                    ...
                    if (resolvedOpts.env !== 'test') {
                        this.app.listen(resolvedOpts.port, function () {
